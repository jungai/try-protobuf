...
export const itempackage = $root.itempackage = (() => {
    ...
    itempackage.ItemResp = (function() {

        /**
         * Properties of an ItemResp.
         * @memberof itempackage
         * @interface IItemResp
         * @property {number|null} [id] ItemResp id
         * @property {string|null} [name] ItemResp name
         */

        /**
         * Constructs a new ItemResp.
         * @memberof itempackage
         * @classdesc Represents an ItemResp.
         * @implements IItemResp
         * @constructor
         * @param {itempackage.IItemResp=} [properties] Properties to set
         */
        function ItemResp(properties) {
            if (properties)
         ...
         * ItemResp id.
         * @member {number} id
         * @memberof itempackage.ItemResp
         * @instance
         */
        ItemResp.prototype.id = 0;
         ...
         * @static
         * @param {itempackage.IItemResp=} [properties] Properties to set
         * @returns {itempackage.ItemResp} ItemResp instance
         */
        ItemResp.create = function create(properties) {
            return new ItemResp(properties);
        };
         ...
         * @memberof itempackage.ItemResp
         * @static
         * @param {itempackage.IItemResp} message ItemResp message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        ItemResp.encode = function encode(message, writer) {
            if (!writer)
         ...
         * @returns {$protobuf.Writer} Writer
         */
        ItemResp.encodeDelimited = function encodeDelimited(message, writer) {
         ...
         * @returns {itempackage.ItemResp} ItemResp
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        ItemResp.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.itempackage.ItemResp();
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        ItemResp.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
         ...
         */
        ItemResp.verify = function verify(message) {
         ...
         * @returns {itempackage.ItemResp} ItemResp
         */
        ItemResp.fromObject = function fromObject(object) {
            if (object instanceof $root.itempackage.ItemResp)
                return object;
            let message = new $root.itempackage.ItemResp();
            if (object.id != null)
         ...
         * @memberof itempackage.ItemResp
         * @static
         * @param {itempackage.ItemResp} message ItemResp
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        ItemResp.toObject = function toObject(message, options) {
            if (!options)
                options = {};
            let object = {};
            if (options.defaults) {
         ...
         */
        ItemResp.prototype.toJSON = function toJSON() {
         ...
         */
        ItemResp.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/itempackage.ItemResp";
        };
...
export const userpackage = $root.userpackage = (() => {
    ...
    userpackage.UserResp = (function() {
        ...
        UserResp.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.userpackage.UserResp();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1: {
        ...
        UserResp.fromObject = function fromObject(object) {
            if (object instanceof $root.userpackage.UserResp)
                return object;
            let message = new $root.userpackage.UserResp();
            if (object.id != null)
                message.id = object.id | 0;
            if (object.name != null)
                message.name = String(object.name);
