...
$root.itempackage = (function() {
    ...
    itempackage.ItemResp = (function() {
        ...
        ItemResp.decode = function decode(reader, length) {
            ...
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.itempackage.ItemResp();
        ...
        ItemResp.fromObject = function fromObject(object) {
            if (object instanceof $root.itempackage.ItemResp)
                return object;
            var message = new $root.itempackage.ItemResp();
            if (object.id != null)
